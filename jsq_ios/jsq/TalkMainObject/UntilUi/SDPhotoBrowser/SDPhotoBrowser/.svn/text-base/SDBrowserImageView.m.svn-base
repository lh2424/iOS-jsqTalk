...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    [self sd_setImageWithURL:url placeholderImage:placeholder options:SDWebImageRetryFailed | SDWebImageRefreshCached progress:^(NSInteger receivedSize, NSInteger expectedSize) {
...
{
    if ((_totalScale < 0.5f && totalScale < _totalScale) || (_totalScale > 2.0 && totalScale > _totalScale)) return; // 最大缩放 2倍,最小0.5倍
...
//        _zoomingScroolView.maximumZoomScale = 2.0f;
//        _zoomingScroolView.minimumZoomScale = 0.5f;
//        [self addSubview:_zoomingScroolView];
//        
//        UIImageView * zoomingImageView = [[UIImageView alloc] initWithFrame:self.bounds];
//        zoomingImageView.image = self.image;
//        zoomingImageView.contentMode = UIViewContentModeScaleAspectFill;
//        _zoomingImageView = zoomingImageView;
//        [_zoomingScroolView addSubview:zoomingImageView];
//        
//        _zoomingScroolView.contentSize = zoomingImageView.bounds.size;
//    }
//}
